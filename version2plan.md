...
| Iframe wallet injection | **@impersonator/iframe** | Passes wallet context into iframe'd apps; tx requests bubble to parent. Prior art: DynOS-95 uses this same approach. |
...
### DynOS-95
- Repo: https://github.com/DynOS-95/DynOS-95
- Built by BuidlGuidl devs in 2024 — Windows 95 aesthetic crypto desktop
- **What they did:** react95 for UI, @impersonator/iframe for wallet injection into iframes, dApps as double-click-to-open iframes, icon grid on desktop
- **What they didn't do:** No real drag/resize — windows are fixed-position modals, no WebRTC, no AI
- **Key takeaway:** Validates the iframe + @impersonator/iframe pattern. Good reference for desktop icon grid layout and the ModalIframe component pattern.
- **Difference:** We want true draggable/resizable windows (Mac OS 9 not Win95), WebRTC video guests, and AI-spawned apps.
